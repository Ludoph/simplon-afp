...
struct Article1a: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing:30) {
                HStack {
                    Text("Cyberharcèlement haineux et homophobe : Eddy de Pretto face à ses harceleurs")
                        .fontWeight(.heavy)
                    VStack (spacing: 30) {
...
struct Article1a_Previews: PreviewProvider {
