                ...
                HStack {
                    ...
                    VStack (spacing: 20) {
                        ...
                        ZStack {
                            ...
                            CirclesView1(isPressed: isPressed, radius: 35, speed: 0.1, scale: 0.7)
                                .opacity(self.opacity)
                            CirclesView1(isPressed: isPressed, radius: 55, speed: 0.2, scale: 0.5)
                                .opacity(self.opacity)
...
struct Temoignage1A_Previews: PreviewProvider {
    static var previews: some View {
        Temoignage1A().environmentObject(UserSetting())
    }
}

struct CirclesView1 : View {
